...
5.  **Case Study Deep-Dive (Swiss Editorial):** Layout de 3 columnas con índice lateral fijo para navegación profunda.

## 5. Decisiones Técnicas Clave
- **Case Study Navigation:** Implementación de "Liquid Sidebar Index". Uso de `position: fixed` (15% width) con sincronización bidireccional mediante `ScrollTrigger` y `ScrollToPlugin`.
